$(document).ready(function(){
    ...
    function UploadAssignment()
    {
        ...
        xhr.open('post', "https://localhost:44373/api/teachers/sections/"+$("#sectionid_upload").val()+"/subjects/"+$("#subjectid_upload").val()+"/assignments/t/"+localStorage.userid, true);
        xhr.send(data);
    ...
    {
	$.ajax({
		url:"https://localhost:44373/api/teachers/sections/"+$("#sectionid_upload").val()+"/subjects/"+$("#subjectid_upload").val()+"/assignments/t/"+localStorage.userid+"/db/",
		method:"post",
		headers:{
			contentType:"application/json"
		},
